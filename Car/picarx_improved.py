...
class picarx_improved:
    ...
    def backward(self, speed):
        ...
        if current_angle != 0:
            ...
            pscale = (100 - abs_current_angle) / 100.0
            print("Power Scale:",pscale)
            if (current_angle / abs_current_angle) > 0:
                self.set_motor_speed(1, -1*speed)
                self.set_motor_speed(2, speed * pscale)
            else:
                self.set_motor_speed(1, -1*speed * pscale)
                self.set_motor_speed(2, speed)
        else:
            self.set_motor_speed(1, -1*speed)
            self.set_motor_speed(2, speed)
    ...
    def forward(self,speed):
        ...
        if current_angle != 0:
            ...
            if (current_angle / abs_current_angle) > 0:
                self.set_motor_speed(1, speed)
                self.set_motor_speed(2, -1*speed * pscale)
            else:
                self.set_motor_speed(1, speed * pscale)
